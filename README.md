This is a very small bash script explaining, in it's simplest form, how you can automatically update Akamai EdgeDNS byt monitoring writes to a zone file on disk.
